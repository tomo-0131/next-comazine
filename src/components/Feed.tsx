...
const Feed: React.FC = () => {
  ...
  return (
    <>
      <div className='flex justify-between items-center bg-teal-600 h-[400px] border-y border-black py-10 lg:py-0 hover:opacity-50 hover:bg-gray-900 max-w-7xl mx-auto'>
      ...
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md: gap-6 p-2 md:p-6'>
          {posts.map((post: any, i) => (
            // <Link key={post.id} href={`/posts/${post.slug.current}`}>
